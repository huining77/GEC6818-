...
void* camera_touch(void* argv)
{
    ...
    while (1)
    {
        ...
        else if(((camera_touch.x >650 )&& (camera_touch.y > 100)&& 
                (camera_touch.x<1000)&& (camera_touch.y<300)))
                {
                    //save_bmp(0,0,640,480);
                    //saveBMP(640,480);
                    saveBMP1(255, 138); 
        ...
        else if(((camera_touch.x >650 )&& (camera_touch.y > 220)&& 
                (camera_touch.x<1000)&& (camera_touch.y<480)))
                {
                    char buf1[30]={0};
